...
def createEmptyArticleDict(pmcId=None, source=None, externalId=None, journal=None, \
                           id=None, origFile=None, authors=None, fulltextUrl=None, keywords=None, title=None,
                           abstract=None, \
        ...
        if preferLocal:
            ...
            if not dataset in connCache:
                ...
                if con is None and preferLocal:
                    raise Exception(
                        "Could not find a local copy of Medline. Use a command line option to switch to remote NCBI Eutils lookups. For low-volume crawls (< 10000), remote lookups are sufficient.")
